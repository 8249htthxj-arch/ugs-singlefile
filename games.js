...
let files = [
  ...
  "cljailbreakobbbobob",
  "clJeffreyEpsteinBasicsInEducationAndKidnapping",
  "cljefflings",
  "cljellydadhero",
  "cljellydrift",
  "clJellyMario",
    ...
    if (filesByChar[char].length > 0) {
      filesByChar[char].forEach((file) => {
        ...
        btn.onclick = () => {
          ...
          fetch(
            `https://cdn.jsdelivr.net/gh/8249htthxj-arch/ugs-singlefile/UGS-Files/${encoded}?t=${Date.now()}`)
          )
